...
<style>
    ...
    .stColumn { display: block !important; width: 100% !important; margin: 0 !important; }
    .custom-card { padding: 20px !important; margin-bottom: 16px !important; }
    .stat-card { padding: 16px !important; }
    .stat-num { font-size: 36px !important; }
    .upload-area { padding: 30px 15px !important; }
    .hazard-card { padding: 15px !important; }
</style>
...
def load_css():
    ...
    <style>
        ...
        .top-header img { height: 45px; width: auto; }
        .top-title { font-size: 24px; font-weight: 700; color: white; letter-spacing: 1px; }
...
def main_page():
    ...
    <div class="top-header">
        ...
        <span class="top-title"> 甬高・安眸</span>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown(f'''
    <div class="stat-card">
        <div class="stat-num" style="color:red">{major}</div>
        <div class="stat-label">重大隐患</div>
        <div style="height:10px"></div>
        <div class="stat-num" style="color:orange">{minor}</div>
